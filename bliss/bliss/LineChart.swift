...
public class LineChart: UIView {
    ...
    */
    ...
    public struct Grid {
        ...
        // #eeeeee
        public var color: UIColor = UIColor(red: 48/255.0, green: 177/255.0, blue: 137/255.0, alpha: 1)
    }
...
//            if area { drawAreaBeneathLineChart(lineIndex) }
    ...
    private func getMinimumValue() -> CGFloat {
        ...
        //here for 5 because the average baby weight is 6, they should not be lower than 4
        return 4
    }
...
//        x.grid.color = UIColor.whiteColor()
        let path = UIBezierPath()
        var x1: CGFloat
...
//     var dotInnerColor = UIColor.whiteColor()
